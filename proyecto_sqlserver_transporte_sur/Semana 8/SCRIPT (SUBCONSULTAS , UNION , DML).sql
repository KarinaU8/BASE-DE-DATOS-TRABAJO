...
-- Procedimiento para actualizar el estado de un mantenimiento
...
-- Función para calcular la cantidad de mantenimientos de un técnico
...
-- Vista para ver los mantenimientos junto con la información completa
...
-- Consulta la vista para verificar
